...
<head>
    ...
    <title>Shop | WOMEN's FASHION STORE</title>
					...
					<div class="col-sm-6 ">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href="contact-us.aspx"><i class="fa fa-envelope"></i> Womenfashionstore@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav navbar-nav">
								<li><a href="https://m.facebook.com/" class="fb btn"><i class="fab fa-facebook-f"></i></a></li>
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="homepage.aspx"><img src="images/home/logo.jpg" alt="" /></a>
						</div>
					...
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="addtocart.aspx"><i class="fa fa-star"></i> Wishlist</a></li>
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							<div class="panel panel-default">
								...
								<div id="sportswear" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="product-details.aspx">Nike </a></li>
											<li><a href="product-details.aspx">Under Armour </a></li>
											<li><a href="product-details.aspx">Adidas </a></li>
											<li><a href="product-details.aspx">Puma</a></li>
											<li><a href="product-details.aspx">ASICS </a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								...
								<div id="mens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="product-details.aspx">TOP WEAR</a></li>
											<li><a href="product-details.aspx">BOTTOM WEAR</a></li>
											<li><a href="product-details.aspx">JUMPSUIT</a></li>
											<li><a href="product-details.aspx">WESTERN DRESS</a></li>
											<li><a href="product-details.aspx">KURTI SET</a></li>
											<li><a href="product-details.aspx">SAREE</a></li>
											<li><a href="product-details.aspx">BRIDAL WEAR</a></li>
											<li><a href="product-details.aspx">SLEEP WEAR</a></li>
											<li><a href="product-details.aspx">MATERNITY</a></li>
											<li><a href="product-details.aspx">DUPATTA</a></li>
											<li><a href="product-details.aspx">SKIRT</a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<div class="panel panel-default">
								...
								<div id="womens" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="product-details.aspx">Fendi</a></li>
											<li><a href="product-details.aspx">Guess</a></li>
											<li><a href="product-details.aspx">Valentino</a></li>
											<li><a href="product-details.aspx">Dior</a></li>
											<li><a href="product-details.aspx">Versace</a></li>
										</ul>
									</div>
								</div>
							</div>
							<div class="panel panel-default">
								...
								<div id="fashion care" class="panel-collapse collapse">
									<div class="panel-body">
										<ul>
											<li><a href="product-details.aspx">SKIN CARE</a></li>
											<li><a href="product-details.aspx">HAIR CARE</a></li>
											<li><a href="product-details.aspx">MAKEUP</a></li>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a href="product-details.aspx">JEWELLERY </a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="product-details.aspx">PERFUME</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="product-details.aspx">SUNGLASSES</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="product-details.aspx">WATCHES</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="product-details.aspx">Bags</a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a href="product-details.aspx">FOOTWEAR</a></h4>
								</div>
							</div>
					...
					<div class="features_items"><!--features_items-->
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/p1.jpg" alt="" />
										<h2>$350</h2>
										<p>perfume</p>
										<a href="addtocart.aspx" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/footwere.jpg" alt="" />
										<h2>$100</h2>
										<p>footwere</p>
										<a href="addtocart.aspx" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
